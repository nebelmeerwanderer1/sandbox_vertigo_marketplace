    ...
    <div className={classes.section}>
      ...
      <div>
        <GridContainer >
          ...
          <h2 className={classes.title}>Upload asset to </h2>
          <h2 className={classes.title}>InterPlanetary File System</h2>
          <h5 className={classes.description}>
            Also referred to as (IPFS)
          ...
          <GridItem xs={12} sm={12} md={6}>
          <h2 className={classes.title}>Mint your NFT</h2>
        ...
        {mintstatus}
           ...
           <GridItem xs={12} sm={12} md={6}>
          <h2 className={classes.title}>Update your NFT</h2>
