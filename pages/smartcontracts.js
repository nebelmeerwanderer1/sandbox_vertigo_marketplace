    ...
    return (
      ...
      <section class="text-gray-600 body-font">
          ...
          <div class="flex flex-col text-center w-full mb-10">
            <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">TIME TO UNDERSTAND</h2>
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Smart Contracts</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">(WORK IN PROGRESS) Why smart contracts are not smart - and still a bit clever</p>
          ...
          <div class="flex flex-wrap">            
            <div class="xl:w-1/2 lg:w-1/2 md:w-full px-8 py-3 border-l-2 border-gray-200 border-opacity-60">
              <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">(WORK IN PROGRESS)</h2>
              <p class="leading-relaxed text-base">(WORK IN PROGRESS)</p>
            ...
            <div class="xl:w-1/2 lg:w-1/2 md:w-full px-8 py-3 border-l-2 border-gray-200 border-opacity-60">
              <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">(WORK IN PROGRESS)</h2>
              <p class="leading-relaxed text-base mb-4">(WORK IN PROGRESS)</p>
