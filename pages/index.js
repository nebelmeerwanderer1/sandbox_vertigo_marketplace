...
import StepsSection from "../pages-sections/LandingPage-Sections/StepsSection.js";
        ...
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>The NFT Laboratory.</h1>
              <h4>
                Create and interact with Non-Fungible Tokens 
                (NFTs) defined by standard and advanced smart 
                contracts following the ERC-721 standard.
              </h4>
              <br />
              {/* <Button
                color="danger"
